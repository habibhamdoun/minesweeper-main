...
var totalMines = 5; // total number of mines
  ...
  for (i = 0; i < totalButtons; i++) {
    ...
    if (expMines.includes(parseInt(button.id))) {
      ...
      if (firstColumn.includes(parseInt(button.id))) {
        ...
        if (expMines.includes(parseInt(button.id) - 8)) count++;
        if (expMines.includes(parseInt(button.id) - 7)) count++;
        if (expMines.includes(parseInt(button.id) + 1)) count++;
        if (expMines.includes(parseInt(button.id) + 8)) count++;
        if (expMines.includes(parseInt(button.id) + 9)) count++;
                ...
                function revealEmpty() {
                  if (firstColumn.includes(parseInt(button.id))) {
                    ...
                    if (parseInt(button.id) + 9 < totalButtons) {
                      if (
                        !document
                          .getElementById(parseInt(button.id) + 9)
                          .classList.contains('flagged')
                      ) {
                        document
                          .getElementById(parseInt(button.id) + 9)
                    ...
                    if (parseInt(button.id) + 8 < totalButtons) {
                      if (
                        !document
                          .getElementById(parseInt(button.id) + 8)
                          .classList.contains('flagged')
                      ) {
                        document
                          .getElementById(parseInt(button.id) + 8)
                    ...
                    if (parseInt(button.id) - 7 > 0) {
                      if (
                        !document
                          .getElementById(parseInt(button.id) - 7)
                          .classList.contains('flagged')
                      ) {
                        document
                          .getElementById(parseInt(button.id) - 7)

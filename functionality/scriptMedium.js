...
var totalMines = 34; // total number of mines
...
var totalButtons = 225; // total number of buttons
...
function start() {
  ...
  for (i = 0; i < totalButtons; i++) {
    ...
    if (expMines.includes(parseInt(button.id))) {
      ...
      if (firstColumn.includes(parseInt(button.id))) {
        ...
        if (expMines.includes(parseInt(button.id) - 14)) count++;
        if (expMines.includes(parseInt(button.id) - 15)) count++;
        if (expMines.includes(parseInt(button.id) + 1)) count++;
        if (expMines.includes(parseInt(button.id) + 16)) count++;
        if (expMines.includes(parseInt(button.id) + 15)) count++;
                ...
                function revealEmpty() {
                  if (firstColumn.includes(parseInt(button.id))) {
                    ...
                    if (parseInt(button.id) + 16 < totalButtons) {
                      if (
                        !document
                          .getElementById(parseInt(button.id) + 16)
                          .classList.contains('flagged')
                      ) {
                        document
                          .getElementById(parseInt(button.id) + 16)
                    ...
                    if (parseInt(button.id) + 15 < totalButtons) {
                      if (
                        !document
                          .getElementById(parseInt(button.id) + 15)
                          .classList.contains('flagged')
                      ) {
                        document
                          .getElementById(parseInt(button.id) + 15)
                    ...
                    if (parseInt(button.id) - 14 > 0) {
                      if (
                        !document
                          .getElementById(parseInt(button.id) - 14)
                          .classList.contains('flagged')
                      ) {
                        document
                          .getElementById(parseInt(button.id) - 14)
  ...
  document.getElementById('hint').addEventListener('click', function hints() {
    ...
    if (hintCount === totalHints) {
      ...
      if (
        !document
          .getElementById(parseInt(expMines[hintMine]))
          .classList.contains('flagged')
      ) {
        document.getElementById(parseInt(expMines[hintMine])).innerHTML =
